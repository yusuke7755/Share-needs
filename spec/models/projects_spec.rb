...
RSpec.describe 'レポートの作成', type: :model do
    ...
    describe '登録のテスト' do
      context '全て入力されたとき' do
        it '登録される' do
          ...
          project = Project.new(title: 'レポート作成' , department: department1 , employee: employee1 , customer: customer1  , customeruser: customeruser1 , package: package1  , feature: feature1  , apoint_at: '2021-08-20' , deadline: '2021-08-29' , description: '成功テスト' , priority: 1 )
